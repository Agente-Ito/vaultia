...
export interface IERC725XInterface extends Interface {
  getFunction(
    nameOrSignature: "execute" | "executeBatch" | "supportsInterface"
  ): FunctionFragment;

  getEvent(
    nameOrSignatureOrTopic: "ContractCreated" | "Executed"
  ): EventFragment;
...
export interface IERC725X extends BaseContract {
  connect(runner?: ContractRunner | null): IERC725X;
