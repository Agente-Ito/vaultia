...
export interface LSP6KeyManagerCoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "execute"
      | "executeBatch"
...
export interface LSP6KeyManagerCore extends BaseContract {
  connect(runner?: ContractRunner | null): LSP6KeyManagerCore;
  waitForDeployment(): Promise<this>;

  interface: LSP6KeyManagerCoreInterface;
