...
export interface LSP9VaultCoreInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface LSP9VaultCore extends BaseContract {
  connect(runner?: ContractRunner | null): LSP9VaultCore;
  waitForDeployment(): Promise<this>;

  interface: LSP9VaultCoreInterface;
